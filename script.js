...
if (enrollmentForm) {
    enrollmentForm.addEventListener('submit', async (e) => {
        ...
        // Validate age matches selected program
        const age = parseInt(data.age);
        const program = data.program;

        let ageValid = true;
        if (program === 'foundation' && (age < 8 || age > 11)) {
            alert('Foundation Program is for ages 8-11. Please select the appropriate program for your child\'s age.');
            ageValid = false;
        } else if (program === 'advanced' && (age < 12 || age > 14)) {
            alert('Advanced Program is for ages 12-14. Please select the appropriate program for your child\'s age.');
            ageValid = false;
        } else if (program === 'elite' && (age < 15 || age > 16)) {
            alert('Elite Program is for ages 15-16. Please select the appropriate program for your child\'s age.');
            ageValid = false;
        }
        ...
        try {
            ...
            showModal(
                ...
                `Thank you for enrolling ${data.studentName}! Your enrollment ID is ${enrollmentId}. We will contact you at ${data.email} within 24 hours to complete the registration process.`
            );
    ...
    contactForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            showModal(
                ...
                `Thank you for reaching out! Your message ID is ${messageId}. We will get back to you as soon as possible.`
            );
